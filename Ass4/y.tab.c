...
{
       0,   304,   304,   305,   306,   309,   310,   311,   314,   315,
...
{
  "\"end of file\"", "error", "\"invalid token\"", "ZERO", "ONE", "PLUS",
  "MINUS", "VAR", "POW", "NUM", "$accept", "S", "P", "T", "X", "N", "M", YY_NULLPTR
};
...
{
       8,     2,    16,    16,    -5,     2,     4,    -6,    21,    -6,
       0,     2,     2,     2,    -6,    -6,    -6,    12,    -6,    -6,
      16,    16,    -6,    -6,    -6,    -6,     2,    -6,    -6,    -6
};
...
{
       0,     8,     0,     0,    12,    14,     0,     2,     5,    10,
       9,    17,    18,    19,    15,     3,     4,     0,    16,     1,
...
{
      15,    16,    18,    17,    19,    11,    12,     4,    23,    24,
      25,    13,     1,     2,     3,     4,    26,     5,    28,    29,
       1,     5,    27,     4,    22,     5,    20,    21
};

static const yytype_int8 yycheck[] =
{
       2,     3,     5,     8,     0,     3,     4,     7,    11,    12,
      13,     9,     4,     5,     6,     7,     4,     9,    20,    21,
       4,     9,    17,     7,    10,     9,     5,     6
};
...
static const yytype_int8 yystos[] =
{
      ...
      15,     3,     4,     9,    16,    12,    12,     8,    16,     0,
       5,     6,    14,    16,    16,    16,     4,    15,    12,    12
};
...
yyreduce:
  ...
  case 2: /* S: P  */
#line 304 "poly.y"
       {(yyval.node) = createPtree("S",(yyvsp[0].node),NULL);DonePTree((yyval.node));}
#line 1430 "y.tab.c"
    break;

  case 3: /* S: PLUS P  */
#line 305 "poly.y"
              {(yyval.node) = createPtree("S",createPtree("+",NULL,NULL),(yyvsp[0].node));DonePTree((yyval.node));}
#line 1436 "y.tab.c"
    break;
...
#line 1442 "y.tab.c"
  ...
  case 5: /* P: T  */
#line 309 "poly.y"
       {(yyval.node) = createPtree("P",(yyvsp[0].node),NULL);}
#line 1448 "y.tab.c"
    break;

  case 6: /* P: T PLUS P  */
#line 310 "poly.y"
               {(yyval.node) = createPtree("P",(yyvsp[-2].node),createPtree("ignore",createPtree("+",NULL,NULL),(yyvsp[0].node)));}
#line 1454 "y.tab.c"
    break;
...
#line 1460 "y.tab.c"
  ...
  case 8: /* T: ONE  */
#line 314 "poly.y"
        {(yyval.node) = createPtree("T",createPtree("1",NULL,NULL),NULL);}
#line 1466 "y.tab.c"
    break;

  case 9: /* T: N  */
#line 315 "poly.y"
          {(yyval.node) = createPtree("T",(yyvsp[0].node),NULL);}
#line 1472 "y.tab.c"
    break;
...
#line 1478 "y.tab.c"
  ...
  case 11: /* T: N X  */
#line 317 "poly.y"
               {(yyval.node) = createPtree("T",(yyvsp[-1].node),(yyvsp[0].node));}
#line 1484 "y.tab.c"
    break;

  case 12: /* X: VAR  */
#line 320 "poly.y"
         {(yyval.node) = createPtree("X",createPtree("x",NULL,NULL),NULL);}
#line 1490 "y.tab.c"
    break;

  case 13: /* X: VAR POW N  */
#line 321 "poly.y"
                {(yyval.node) = createPtree("X",createPtree("ignore",createPtree("x",NULL,NULL),createPtree("^",NULL,NULL)),(yyvsp[0].node));}
#line 1496 "y.tab.c"
    break;

  case 14: /* N: NUM  */
#line 324 "poly.y"
        {(yyval.node) = createPtree("N",createPtree((yyvsp[0].val),NULL,NULL),NULL);}
#line 1502 "y.tab.c"
    break;

  case 15: /* N: ONE M  */
#line 325 "poly.y"
             {(yyval.node) = createPtree("N",createPtree("1",NULL,NULL),(yyvsp[0].node));}
#line 1508 "y.tab.c"
    break;

  case 16: /* N: NUM M  */
#line 326 "poly.y"
             {(yyval.node) = createPtree("N",createPtree((yyvsp[-1].val),NULL,NULL),(yyvsp[0].node));}
#line 1514 "y.tab.c"
    break;

  case 17: /* M: ZERO  */
#line 329 "poly.y"
          {(yyval.node) = createPtree("M",createPtree("0",NULL,NULL),NULL);}
#line 1520 "y.tab.c"
    break;

  case 18: /* M: ONE  */
#line 330 "poly.y"
          {(yyval.node) = createPtree("M",createPtree("1",NULL,NULL),NULL);}
#line 1526 "y.tab.c"
    break;

  case 19: /* M: NUM  */
#line 331 "poly.y"
          {(yyval.node) = createPtree("M",createPtree((yyvsp[0].val),NULL,NULL),NULL);}
#line 1532 "y.tab.c"
    break;

  case 20: /* M: ZERO M  */
#line 332 "poly.y"
             {(yyval.node) = createPtree("M",createPtree("0",NULL,NULL),(yyvsp[0].node));}
#line 1538 "y.tab.c"
    break;

  case 21: /* M: ONE M  */
#line 333 "poly.y"
            {(yyval.node) = createPtree("M",createPtree("1",NULL,NULL),(yyvsp[0].node));}
#line 1544 "y.tab.c"
    break;

  case 22: /* M: NUM M  */
#line 334 "poly.y"
            {(yyval.node) = createPtree("M",createPtree((yyvsp[-1].val),NULL,NULL),(yyvsp[0].node));}
#line 1550 "y.tab.c"
    break;
